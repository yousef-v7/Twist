...
// This function is used to get the user data from the database by clerkId
...
// Fetches the user ID from the database using the currently authenticated Clerk user ID.
